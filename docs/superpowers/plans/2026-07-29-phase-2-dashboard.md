...
`public/data/` is copied in at build time and `routeTree.gen.ts` is generated by
the router plugin — neither belongs in git.
...
describe('StatusBadge', () => {
  ...
  it('explains stale data and when it went stale', () => {
    render(<StatusBadge status="stale" staleSince="2026-07-29T04:30:36+03:00" />)
